...
σε μια ΒΔ ονομάζεται **σύνολο οντοτήτων**. Τα γνωρίσματα του είναι ελλείψεις που
...
το σύνολο τιμών του γνωρίσματος ηλικία της οντότητας ΕΡΓΑΖΟΜΕΝΟΣ
...
έχει διακεκριμμένες τιμές για κάθε ξεχωριστή οντότητα (πχ ΑΤ φοιτητή, ΑΜΚΑ εργαζομένου,
Αρ. πλαισίου αυτοκινήτου, ΙΜΟ πλοίου κοκ) (δηλαδή δε μπορεί να
υπάρχουν δύο διαφορετικές οντότητες με ίδιες τιμές στο συγκεκριμένο γνώρισμα
ή εφόσον δύο οντότητες έχουν την ίδια τιμή στο συγκεκριμένο γνώρισμα συνεπάγεται
...
συμμετέχει μερικώς ενώ ο τύπος οντότητας τμήμα συμμετέχει ολικά. Η ολική συμμετοχή
